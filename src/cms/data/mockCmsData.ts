...
export const cmsMenuGroupsMock: CmsMenuGroup[] = [
  ...
  {
    id: 'grp_quan_tri',
    groupTitle: 'QUẢN TRỊ & PHÂN QUYỀN',
    items: [
      {
        id: 'menu_admin_users',
  ...
  {
    id: 'grp_san_pham',
    groupTitle: 'SẢN PHẨM & KINH DOANH',
    items: [
      {
        id: 'menu_products',
      ...
      {
        id: 'menu_prod_categories',
        title: 'Danh mục sản phẩm',
        iconName: 'FolderTree',
        path: '/cms/product-categories',
      },
      {
      ...
      },
      {
        ...
        iconName: 'Layers',
        path: '/cms/product-types',
      },
      {
        id: 'menu_product_filters',
        title: 'Thuộc tính & Bộ lọc',
        iconName: 'Filter',
        path: '/cms/product-attributes',
      },
      {
  ...
  {
    id: 'grp_dia_diem',
    groupTitle: 'ĐỊA ĐIỂM & LIÊN HỆ',
    items: [
      {
        id: 'menu_contact_addresses',
      ...
      {
        id: 'menu_online_support',
        title: 'Kênh hỗ trợ trực tuyến',
        iconName: 'Headphones',
        path: '/cms/online-support',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'Cấu hình SEO',
        iconName: 'Globe',
        path: '/cms/seo-settings',
      },
      {
        id: 'menu_trending_keywords',
        title: 'Từ khóa tìm kiếm',
        iconName: 'Sparkles',
        path: '/cms/trending-keywords',
      },
      {
        id: 'menu_traffic_analytics',
        title: 'Thống kê truy cập',
        iconName: 'TrendingUp',
        path: '/cms/traffic-stats',
      },
      {
        id: 'menu_enjicad_config',
        title: 'Cấu hình Enjicad',
        iconName: 'ExternalLink',
        path: '/cms/enjicad-config',
      },
    ],
  },
  {
    id: 'grp_menu_dieu_huong',
    groupTitle: 'MENU & ĐIỀU HƯỚNG',
    items: [
      {
        id: 'menu_frontend_groups',
        title: 'Nhóm Menu Website',
        iconName: 'ListOrdered',
        path: '/cms/menu-groups',
      },
      {
        id: 'menu_frontend_list',
        title: 'Cấu trúc Menu Website',
        iconName: 'Menu',
        path: '/cms/frontend-menus',
      },
      {
        id: 'menu_admin_nav',
        title: 'Cấu trúc Menu Admin',
        iconName: 'Command',
        path: '/cms/admin-menus',
      },
    ],
  },
];
