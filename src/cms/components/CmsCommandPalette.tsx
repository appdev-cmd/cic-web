...
export const CmsCommandPalette: React.FC<CmsCommandPaletteProps> = ({
  ...
  const quickPages = [
    ...
    { label: 'Danh sách Đăng ký liên hệ Sản phẩm', category: 'Kinh doanh', path: '/cms/product-registrations', icon: Package },
    { label: 'Tin nhắn liên hệ từ khách hàng', category: 'Địa điểm & Liên hệ', path: '/cms/contact-messages', icon: FileText },
