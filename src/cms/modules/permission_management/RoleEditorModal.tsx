...
import type { CmsRole, MatrixAction, ModulePermissionMatrix } from './types';
...
export const RoleEditorModal: React.FC<RoleEditorModalProps> = ({ isOpen, onClose, onSaveRole, roleToEdit }) => {
  ...
  const save = () => {
    ...
    const saved: CmsRole = {
      ...
      matrix, assignedUsersCount: roleToEdit?.assignedUsersCount ?? 0, assignedGroupCount: roleToEdit?.assignedGroupCount ?? 0,
