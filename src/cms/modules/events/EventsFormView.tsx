...
export const EventsFormView: React.FC<EventsFormViewProps> = ({ eventToEdit, locale = 'vi', relatedEvents, relatedArticles, relatedProducts, mediaImages, featuredCount, onSave, onOpenPreview, onCancel }) => {
  ...
  return <div className="space-y-5 pb-16">
    ...
    {mediaPickerOpen && <PageMediaPickerModal currentId={image} returnValue="url" locale={locale} images={mediaImages} onClose={() => setMediaPickerOpen(false)} onConfirm={(val) => { if (val) setImage(val); }} />}
  </div>;
};
