...
export const EventsFormView: React.FC<EventsFormViewProps> = ({ eventToEdit, relatedEvents, relatedArticles, relatedProducts, onSave, onOpenPreview, onCancel }) => {
