...
export const MOCK_CTAS: CtaItem[] = [
  {
    id: 'cta_explore_products',
    adminName: 'CTA hệ thống · Khám phá sản phẩm',
    displayText: 'Khám phá sản phẩm',
    description: 'CTA cố định trong Hero trang chủ',
    code: 'cta_explore_products',
    icon: 'ArrowRight',
    styleVariant: 'primary',
    actionConfig: { type: 'redirect_internal', url: '/san-pham' },
    status: 'active',
    usedByCount: 1,
    usedByPages: [{ pageId: 'home', pageTitle: 'Trang chủ', pagePath: '/', placementKey: 'home.hero.primary' }],
  ...
  {
    id: 'cta_about_cic',
    adminName: 'CTA hệ thống · Tìm hiểu CIC',
    displayText: 'Tìm hiểu về CIC',
    description: 'CTA cố định dẫn tới trang Giới thiệu',
    code: 'cta_about_cic',
    icon: 'Building',
    styleVariant: 'outline',
    actionConfig: { type: 'redirect_internal', url: '/gioi-thieu' },
    status: 'active',
    usedByCount: 2,
    usedByPages: [{ pageId: 'home', pageTitle: 'Trang chủ', pagePath: '/', placementKey: 'home.hero.secondary' }],
    analytics: { impressions: 0, clicks: 0, ctr: 0 },
    governance: { origin: 'system', allowedPlacements: ['fixed_section'], fixedPlacementKeys: ['home.hero.secondary', 'home.intro.primary'] },
    createdBy: 'System',
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2025-01-01T00:00:00Z',
  },
  {
    id: 'cta_contact',
    adminName: 'CTA hệ thống · Liên hệ',
    displayText: 'Liên hệ ngay',
    description: 'CTA cố định tại các khu vực liên hệ',
    code: 'cta_contact',
    icon: 'MessageSquare',
    styleVariant: 'primary',
    actionConfig: { type: 'open_form', formId: 'form_contact_request' },
    status: 'active',
    usedByCount: 1,
    usedByPages: [{ pageId: 'about', pageTitle: 'Giới thiệu', pagePath: '/gioi-thieu', placementKey: 'about.contact_cta' }],
    analytics: { impressions: 0, clicks: 0, ctr: 0 },
    governance: { origin: 'system', allowedPlacements: ['fixed_section'], fixedPlacementKeys: ['about.contact_cta'] },
    createdBy: 'System',
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2025-01-01T00:00:00Z',
  },
  ...
  {
    governance: { origin: 'system', allowedPlacements: ['fixed_section'], fixedPlacementKeys: ['product.download'] },
    id: 'cta_003',
  ...
  {
    governance: { origin: 'system', allowedPlacements: ['fixed_section'], fixedPlacementKeys: ['site.header.hotline'] },
    id: 'cta_004',
