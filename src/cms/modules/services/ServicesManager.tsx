...
export const ServicesManager: React.FC<ServicesManagerProps> = ({ workspaceLocale, data }) => {
  ...
  const handleCreateNew = () => {
    const newService: ServiceItem = {
      ...
      title: 'Dịch vụ mới chưa đặt tên',
      slug: 'dich-vu-moi',
      summary: 'Mô tả tóm tắt ngắn dịch vụ...',
      group_id: 'grp_01',
      group_name: 'Tư vấn & Chuyển giao BIM',
      scope: 'Toàn quốc',
      business_relation: 'Dịch vụ độc lập',
      description: '<p>Nội dung mô tả chi tiết dịch vụ mới...</p>',
      benefits_process: 'Lợi ích và quy trình triển khai...',
      supplementary_content: 'Điều khoản và thông tin bổ trợ...',
      ...
      media_alt: 'Hình ảnh dịch vụ mới',
      ...
      request_routing: 'Bộ phận Kinh doanh (sales@cic.com.vn)',
      meta_title: 'Dịch vụ mới | CIC Technology',
      meta_description: 'Mô tả SEO dịch vụ mới...',
      meta_keywords: 'Dịch vụ, CIC',
      og_image: '',
      quality_score: 75,
