...
export const ProductsFormView: React.FC<ProductsFormViewProps> = ({ product, categories, brands, applications: applicationOptions, productTypes, relatedProducts, featuredCount, onSave, onCancel, onOpenPreview }) => {
