        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <label className="relative w-full max-w-md flex-1">
            ...
            <input
              ...
              placeholder={dict.modules.productTaxonomies.applications.searchPlaceholder}
        ...
        <CmsBulkActionBar
          ...
          actions={
            capabilities.edit
              ? [
                  {
                    label: dict.modules.productTaxonomies.applications.bulkDeactivate,
                    icon: Archive,
                    onClick: () =>
                      runMutation(
          ...
          <table className="cms-data-table min-w-[720px] text-left">
            <thead className="border-b border-slate-200 bg-slate-50 text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:border-slate-800 dark:bg-slate-800">
              <tr>
                ...
                <th className="min-w-28 p-3">{dict.modules.productTaxonomies.applications.columns.ordering}</th>
                <th className="min-w-32 p-3">{dict.modules.productTaxonomies.applications.columns.status}</th>
