...
export const cicUsersMock: CicUser[] = [
  {
    ...
    passwordChangedAt: '2026-06-12 10:00:00',
  ...
  },
  {
    ...
    passwordChangedAt: '2025-11-05 14:20:00',
  ...
  },
  {
    ...
    status: 'deactivated',
    primaryRoleId: 'role_sales',
    ordering: 4,
    agencies: ['agency_ct'],
    products_categories: ['cat_p1', 'cat_p6'],
    news_categories: ['cat_n4'],
    two_factor_enabled: false,
    passwordChangedAt: '2025-09-01 09:00:00',
    failed_login_attempts: 0,
    isOnline: false,
