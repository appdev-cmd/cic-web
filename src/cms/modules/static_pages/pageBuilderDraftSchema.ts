...
export const draftSectionSchemas: Record<string, DraftElementDefinition[]> = {
  ...
  'home.projects': [text('title', 'Tiêu đề'), text('subtitle', 'Mô tả', true), text('ctaLabel', 'Nhãn nút', true), text('ctaUrl', 'Đường dẫn nút', true), reference('project', 'Dự án')],
  'home.events': [text('title', 'Tiêu đề'), text('subtitle', 'Mô tả', true), text('ctaLabel', 'Nhãn nút', true), text('ctaUrl', 'Đường dẫn nút', true), reference('event', 'Sự kiện')],
  'home.news': [text('title', 'Tiêu đề'), text('subtitle', 'Mô tả', true), text('ctaLabel', 'Nhãn nút', true), text('ctaUrl', 'Đường dẫn nút', true), reference('news', 'Tin tức')],
  ...
  'about.hero': [text('badge', 'Nhãn', true), text('title', 'Tiêu đề'), text('subtitle', 'Mô tả'), media('backgroundImageId', 'Ảnh nền')],
  'about.overview': [text('title', 'Tiêu đề'), item('paragraphs', 'Các đoạn nội dung'), { key: 'videoUrl', label: 'Video', kind: 'video', optional: true }],
  'about.timeline': [text('badge', 'Nhãn', true), text('title', 'Tiêu đề'), text('description', 'Mô tả'), item('milestones', 'Các mốc thời gian')],
  ...
  'about.offerings': [text('title', 'Tiêu đề'), text('subtitle', 'Mô tả', true), item('items', 'Danh sách giải pháp'), reference('product', 'Sản phẩm'), reference('service', 'Dịch vụ')],
  'about.awards': [booleanField('syncWithHome', 'Đồng bộ từ Trang chủ'), text('title', 'Tiêu đề'), text('subtitle', 'Mô tả', true), text('description', 'Mô tả đoạn văn', true), item('items', 'Giải thưởng')],
