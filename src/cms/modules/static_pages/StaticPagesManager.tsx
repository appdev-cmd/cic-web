    ...
    <div className="space-y-5">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 shadow-2xs space-y-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-slate-100 dark:border-slate-800 text-xs">
          ...
          {/* Toolbar buttons: Thêm mới, Xóa (chọn nhiều dòng), Xuất bản/Ẩn */}
          <div className="flex items-center flex-wrap gap-2">
            {/* Nút Xuất bản hàng loạt */}
            <button
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-1">
                            <a
                              ...
                              className="font-bold text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 line-clamp-2 transition-colors cursor-pointer"
                            >
                              {page.title}
                            </a>
