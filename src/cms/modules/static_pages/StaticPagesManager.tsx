  ...
  return <div className="space-y-5">
    ...
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-2xs dark:border-slate-800 dark:bg-slate-900">
      <div className="grid grid-cols-1 items-center gap-3 md:grid-cols-12">
        ...
        <button type="button" disabled={!query && statusFilter === 'all'} onClick={() => { setQuery(''); setStatusFilter('all'); setCurrentPage(1); }} className="flex items-center justify-center gap-1.5 rounded-xl px-3 py-2 text-xs font-bold text-slate-500 hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-40 md:col-span-3 dark:hover:bg-slate-800"><RotateCcw className="h-3.5 w-3.5" />Đặt lại</button>
      </div>
    </section>
