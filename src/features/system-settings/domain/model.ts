...
export type CmsSettingItem = Readonly<{ key: string; label: string; description: string; group: 'branding' | 'seo' | 'company' | 'footer_social' | 'measurement'; type: SettingsValueType; value: string; publicReadable: boolean; maxLength: number }>;
