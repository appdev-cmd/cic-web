...
const footerPrimaryLinks: FooterNavigationItem[] = [
  { label: 'Trang chủ', href: '/', view: 'home', activeLabel: '', preventDefault: false, scrollToTop: false },
  { label: 'Giải pháp', href: '/products', view: 'products', activeLabel: 'Sản phẩm', reset: true },
...
const footerSolutionLinks: FooterNavigationItem[] = [
  ...
  'Thiết bị khoa học',
  'Net Zero & Bền vững',
].map((label) => ({ label, href: '/products', view: 'products', activeLabel: 'Sản phẩm' }));
