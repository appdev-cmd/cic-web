...
BEGIN
  FOR item IN
    SELECT * FROM (VALUES
      ...
      ('cic_products_categories', 'product_settings'),
      ('cic_products_categories_en', 'product_settings'),
      ('cic_manufactories', 'product_settings'),
      ('cic_manufactories_en', 'product_settings'),
      ('cic_application', 'product_settings'),
      ('cic_application_en', 'product_settings'),
      ('cic_products_types', 'product_settings'),
      ('cic_products_types_en', 'product_settings'),
      ('cic_news_categories', 'news'),
      ('cic_news_categories_en', 'news'),
