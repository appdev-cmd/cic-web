...
|---|---|---|---|---|---|
| `[A]` | Dashboard | aggregates, notifications, work queues | CMS auth/RBAC; read models từ domain nguồn | analytics, audit, workflow queues | Audit chi tiết 2026-09-18: Đã có PostgreSQL query cơ bản cho 5 KPI và contacts; pendingContents, productRegistrations, activityLogs, weeklyContent đang trả mảng rỗng; UI DashboardOverview, Customizer Drawer và Reset Modal hoàn chỉnh; Sẵn sàng implementation kết nối full DB aggregates |
