...
| `/services`, `/services/[slug]` | `ServicesView` | Route/query tối giản đang REPLACE hierarchy reference; relation DB có nhưng rỗng; audit READY_TO_IMPLEMENT với single-row Draft/Published policy |
