...
**Giai đoạn 3 - Xây dựng hệ thống mới và Tối ưu SEO kỹ thuật**

Đây là giai đoạn khắc phục toàn bộ các lỗi cấu trúc đã ghi nhận ở phần đánh giá hiện trạng, tích hợp trực tiếp vào template của hệ thống mới:
...
- Rà soát và cấu hình lại Robots.txt phù hợp với cấu trúc URL mới.
- Bổ sung dữ liệu có cấu trúc (Schema.org/JSON-LD) cho trang sản phẩm và bài viết nếu cần thiết, hỗ trợ hiển thị rich snippet.
...
- Thiết lập noindex/robots.txt disallow trên môi trường staging để tránh Google index nhầm nội dung thử nghiệm.
...
#### 3.3. Các lưu ý để không mất thứ hạng SEO
...
- Giám sát sát sao 30 - 90 ngày đầu tiên sau triển khai, đây là giai đoạn Google đánh giá lại toàn bộ website.
